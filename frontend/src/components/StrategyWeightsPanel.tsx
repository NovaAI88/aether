...
const StrategyWeightsPanel: React.FC = () => {
  ...
  if (!!error && Object.keys(weights).length === 0) return <div style={{color:'#d1b868',padding:10}}>No strategy weights received yet.</div>;
  ...
  return (
    <div style={{padding:16,background:'#232944',borderRadius:13,marginBottom:14,boxShadow:'0 1px 8px #142a3a16',minWidth:220}}>
      ...
      {error && <div style={{color:'#ebda7c',marginBottom:7}}>Refresh error: {error}</div>}
